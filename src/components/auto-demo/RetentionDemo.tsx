...
export function RetentionDemo() {
  ...
  return (
    <div className="auto-demo-shell min-h-screen bg-app text-foreground lg:flex">
      ...
      {mobileNav && <div className="fixed inset-0 z-50 lg:hidden"><Button aria-label="Close navigation" variant="ghost" className="absolute inset-0 h-full w-full rounded-none bg-demo-navy/60" onClick={() => setMobileNav(false)} /><aside className="relative h-full w-[min(82vw,280px)] bg-demo-navy text-demo-navy-foreground shadow-2xl animate-slide-in-right"><Sidebar view={view} navigate={navigate} expanded mobile onToggle={() => setMobileNav(false)} /></aside></div>}
