  ...
  return <div className="min-h-screen bg-white text-neutral-900">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-4 pt-40 pb-20 relative brand-font text-center">
          ...
          <div className="mt-14 overflow-hidden border-y border-neutral-200 py-4 reveal" style={{
          transitionDelay: '400ms'
        }}>
            <div className="marquee">
              {logos.concat(logos, logos).map((n, i) => <div key={n + i} className="text-neutral-600 text-sm tracking-wide">★ Trusted by {n}</div>)}
            </div>
          </div>
        </div>
