...
const BRAND_START = "#DC2626";
const BRAND_END = "#F87171";
  ...
  const features = [
    {
      icon: Phone,
      title: "Smart Calling",
      desc: "AI dials instantly, qualifies patients, books appointments, or schedules callbacks.",
    },
    {
      icon: Bell,
      title: "Owner Alerts",
      desc: "Automatic SMS notifications with patient outcomes for every attempt.",
    },
    {
      icon: BarChart3,
      title: "Analytics",
      desc: "Dashboards for attempts, connects, appointments, and outcomes.",
    },
    {
      icon: Shield,
      title: "Compliance",
      desc: "HIPAA-compliant with quiet hours + opt-out handling built in.",
    },
  ];
    ...
    <div className="min-h-screen bg-white text-neutral-900">
          ...
          >
            <div className="grid grid-cols-[auto_1fr_auto] items-center gap-2 md:gap-6 px-3 md:px-5 py-2 md:py-3 brand-font">
              <div className="flex items-center gap-2 md:gap-3">
                ...
                <span className="text-base md:text-lg tracking-tight brand-title">
                  Rocky AI • <span className="text-neutral-600">Fetch Leads</span>
                </span>
              </div>
              ...
              <nav className="hidden md:flex items-center justify-center gap-8 font-semibold text-neutral-800 select-none">
                ...
                <button onClick={() => go(howRef)} className="hover:opacity-80 cursor-pointer">
                  Agents
                </button>
                <button onClick={() => go(featuresRef)} className="hover:opacity-80 cursor-pointer">
                  Features
                </button>
                <button onClick={() => go(faqRef)} className="hover:opacity-80 cursor-pointer">
                  FAQ
                </button>
                <button onClick={() => go(pricingRef)} className="hover:opacity-80 cursor-pointer">
                  Pricing
                </button>
              </nav>
              ...
              <div className="hidden md:flex items-center gap-3">
                <a
                  href="/login"
                  className="px-3 py-1.5 rounded-full border border-neutral-200 text-neutral-800 hover:bg-neutral-100 transition-all duration-200 ease-out hover:scale-[1.04] hover:shadow-[0_8px_24px_rgba(2,6,23,0.08)]"
                >
                  Sign in
                </a>
                <a
                  href="/signup"
                  className="px-4 h-10 inline-flex items-center gap-2 rounded-full font-semibold text-white bg-red-600 hover:bg-red-700 shadow-[0_6px_20px_rgba(220,38,38,.25)] transition-all duration-200 ease-out hover:scale-[1.06] hover:shadow-[0_14px_36px_rgba(220,38,38,.38)]"
                >
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-4 pt-40 pb-20 relative brand-font text-center">
          ...
          >
            <div
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-neutral-200 bg-white mb-6 text-neutral-700 reveal in"
            ...
            <h1
              className="text-4xl md:text-6xl mb-6 brand-title h1-tuned mx-auto max-w-[22ch] reveal in"
              style={{ transitionDelay: "100ms" }}
            >
              Turn Every Patient Inquiry Into Scheduled Appointments With{" "}
              <span className="brand-text">AI-Powered Calls</span>
            </h1>
            <p
              className="text-base md:text-xl text-neutral-600 max-w-2xl mx-auto mb-10 reveal in"
              style={{ transitionDelay: "200ms" }}
            >
              AI-powered calling that converts physical therapy leads into booked patients through intelligent
              conversations and seamless scheduling.
            </p>
            <div
              className="flex items-center justify-center gap-3 flex-wrap reveal in"
              style={{ transitionDelay: "300ms" }}
            >
              <a
                href="/signup"
                className="px-5 h-11 inline-flex items-center rounded-lg bg-neutral-900 text-white font-semibold hover:bg-black transition-all duration-200 ease-out hover:scale-[1.03] hover:shadow-[0_10px_30px_rgba(2,6,23,0.15)]"
              >
                Get Started
              </a>
              <button
                onClick={() => setTryOpen(true)}
                className="px-5 h-11 inline-flex items-center rounded-lg border border-neutral-200 bg-white text-neutral-800 hover:bg-neutral-50 transition-all duration-200 ease-out hover:scale-[1.03] hover:shadow-[0_8px_24px_rgba(2,6,23,0.08)]"
              >
                Try me
              </button>
            </div>
          ...
          <div className="mt-14 overflow-hidden border-y border-neutral-200 py-4 reveal" style={{ transitionDelay: "400ms" }}>
            <div className="marquee">
              {logos.concat(logos, logos).map((n, i) => (
                <div key={n + i} className="text-neutral-600 text-sm tracking-wide">
                  ★ Trusted by {n}
                </div>
              ))}
            </div>
        ...
        <div className="relative h-24 -mt-2">
          <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1440 120" preserveAspectRatio="none" aria-hidden>
            ...
            <path
              d="M0,45 C240,105 480,105 720,65 C960,25 1200,25 1440,65"
              fill="none"
              stroke="#FCA5A5"
              strokeOpacity="0.6"
              strokeWidth="1"
      ...
      <section ref={howRef} className="py-24 px-4 brand-font">
        <div className="mx-auto max-w-7xl">
          <h3 className="text-2xl font-semibold text-neutral-700 mb-2 reveal" style={{ transitionDelay: "0ms" }}>
            Smart Agents Ready
          </h3>
          <h2 className="text-3xl md:text-5xl font-bold mb-6 brand-title reveal" style={{ transitionDelay: "100ms" }}>
            Meet Your AI Task Force
          </h2>
          <p className="text-neutral-600 max-w-3xl reveal" style={{ transitionDelay: "200ms" }}>
            Discover a growing lineup of intelligent agents built to act. From task automation to complex workflows,
            they think, decide, and execute — so you can focus on what matters.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            {[
              { n: 1, title: "Connect patient inquiry form", desc: "Hook up your patient intake or CRM webhook." },
              {
                n: 2,
                title: "We call in ~3 minutes",
                desc: "Agent qualifies, schedules, or arranges consultation.",
              },
              { n: 3, title: "You get summaries", desc: "Texts + dashboard log of outcomes & next steps." },
            ].map((s, i) => (
              <div
                key={s.n}
                className="p-8 rounded-2xl border border-neutral-200 bg-white hover:bg-neutral-50 transition reveal"
                style={{ transitionDelay: `${150 + i * 100}ms` }}
              >
                <div className="w-10 h-10 rounded-full grid place-items-center font-bold text-white brand-gradient mb-4">
                  {s.n}
                </div>
      ...
      <section ref={featuresRef} className="py-24 px-4 brand-font">
        <div className="mx-auto max-w-7xl">
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-10 brand-title reveal" style={{ transitionDelay: "100ms" }}>
      ...
      <section ref={pricingRef} id="pricing" className="py-28 px-4 brand-font">
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-10">
            <h2
              className="text-3xl md:text-5xl font-bold mb-3 brand-title reveal"
              style={{ transitionDelay: "0ms" }}
            >
              Pricing
            </h2>
            <p className="text-neutral-600 reveal" style={{ transitionDelay: "100ms" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-8 rounded-2xl border border-neutral-200 bg-white reveal" style={{ transitionDelay: "150ms" }}>
              ...
              <ul className="space-y-2 text-neutral-700 mb-6">
                ...
                <li className="flex items-center gap-2">
                  <Check className="w-4 h-4" /> Patient calls & SMS reminders
                </li>
                <li className="flex items-center gap-2">
                  <Check className="w-4 h-4" /> Appointment notifications + daily summary
                </li>
              </ul>
            ...
            <div className="p-8 rounded-2xl border border-neutral-200 bg-neutral-50 reveal" style={{ transitionDelay: "250ms" }}>
              ...
              <p className="text-neutral-700 mb-4">
                Billed <b>after</b> onboarding + DocuSign. Amount agreed on the call (e.g., $500) charged to your card
                on file.
              </p>
              <ul className="space-y-2 text-neutral-700 mb-6">
                <li className="flex items-center gap-2">
                  <Check className="w-4 h-4" /> Custom voice agent configuration
                </li>
                <li className="flex items-center gap-2">
                  <Check className="w-4 h-4" /> Patient intake hookup
                </li>
                <li className="flex items-center gap-2">
                  <Check className="w-4 h-4" /> Go-live checklist & QA
                </li>
              </ul>
            </div>
          </div>
      ...
      <section ref={faqRef} className="py-24 px-4 brand-font">
        <div className="mx-auto max-w-5xl">
          <h2
            className="text-center text-3xl md:text-5xl font-bold mb-10 brand-title reveal"
            style={{ transitionDelay: "0ms" }}
          >
            Frequently Asked Questions
          </h2>
          <div
            className="divide-y divide-neutral-200 rounded-2xl border border-neutral-200 overflow-hidden reveal"
            style={{ transitionDelay: "100ms" }}
          >
            {faqs.map((f, i) => (
              <details
                key={i}
                className="group open:bg-neutral-50 reveal"
